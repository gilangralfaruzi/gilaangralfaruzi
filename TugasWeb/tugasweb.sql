...
--
-- Host: 127.0.0.1
-- Generation Time: 30 Mei 2018 pada 12.15
...
(123612, 'adjawkld', 'aknawd', '2018-05-29', 'ajdhawkd@dawld', 'Laki-Laki', 'Islam', 'Pemasaran', '', 'lawdawd', 'avatar.png', 1);
...
--
ALTER TABLE `karyawan`
  MODIFY `nip` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=123613;
COMMIT;
