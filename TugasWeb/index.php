...
<head>
	...
	<link rel="shortcut icon" href="avatar/iconatasdanlogin.png"/>
	<style>
		.content {
			margin-top: 10px;
		}
...
<body>
	<nav class="navbar navbar-default">
		<div class="navbar-header">
			<table>
				<tr>
					<td><img src="avatar/iconatasdanlogin.png" class="img-responsive" style="max-height:30px"> </td>
					<td><a class="navbar-brand" href="#">Gilang Otomotif</a></td>
				</tr>
			</table>
		</div>
